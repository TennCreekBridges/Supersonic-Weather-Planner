...
// use moment to import current date
dayDisplay.textContent = moment().format('MMM Do, YYYY');

// create empty array for city searches
...
var getCoordinates = function (location) {
  var coordUrl =
    ...
    location +
    '&units=imperial&appid=1f7f67bb2143af57cf3bf01da71a8e1f';
...
// pass location to receive weather data
var searchWeather = function (long, lat, city) {
  apiUrl =
    ...
    '&lon=' +
    long +
    '&exclude=minutely,alerts&&units=imperial&appid=1f7f67bb2143af57cf3bf01da71a8e1f';
